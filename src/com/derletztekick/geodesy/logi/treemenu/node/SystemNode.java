...
public class SystemNode extends DefaultMutableTreeNode {
	private static final long serialVersionUID = -2743483051023011747L;
	private int id = -1;
	private DataTabbedPane dataTabbedPane;

	public SystemNode(int id, String name, DataTabbedPane dataTabbedPane) {
		super(name);
	...
	public final DataTabbedPane getUserObject() {
